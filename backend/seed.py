...
products_data = [
    # Electronics
    {"name": "Wireless Headphones Pro", "slug": "wireless-headphones-pro", "description": "Premium noise-cancelling wireless headphones with 40hr battery life.", "price": 199.99, "original_price": 249.99, "stock": 50, "category_id": cat_map["electronics"], "image_url": "https://placehold.co/400x300?text=Headphones", "sku": "ELEC-001", "is_featured": True},
    ...
    {"name": "4K Webcam Ultra", "slug": "4k-webcam-ultra", "description": "4K resolution webcam with built-in microphone and ring light.", "price": 89.99, "original_price": None, "stock": 75, "category_id": cat_map["electronics"], "image_url": "https://placehold.co/400x300?text=Webcam", "sku": "ELEC-003", "is_featured": False},
    {"name": "Mechanical Keyboard RGB", "slug": "mechanical-keyboard-rgb", "description": "Tactile mechanical switches with customizable RGB lighting.", "price": 129.99, "original_price": 159.99, "stock": 40, "category_id": cat_map["electronics"], "image_url": "https://placehold.co/400x300?text=Keyboard", "sku": "ELEC-004", "is_featured": False},
    # Clothing
    ...
    # Food & Drinks
    {"name": "Organic Green Tea Set", "slug": "organic-green-tea-set", "description": "Premium Japanese green tea collection, 50 individually wrapped sachets.", "price": 29.99, "original_price": None, "stock": 100, "category_id": cat_map["food-drinks"], "image_url": "https://placehold.co/400x300?text=GreenTea", "sku": "FOOD-001", "is_featured": False},
    {"name": "Artisan Coffee Blend", "slug": "artisan-coffee-blend", "description": "Single-origin Ethiopian coffee, medium roast, 500g.", "price": 19.99, "original_price": 24.99, "stock": 120, "category_id": cat_map["food-drinks"], "image_url": "https://placehold.co/400x300?text=Coffee", "sku": "FOOD-002", "is_featured": True},
    ...
    # Books
    {"name": "The Art of Clean Code", "slug": "art-of-clean-code", "description": "A comprehensive guide to writing maintainable and elegant software.", "price": 34.99, "original_price": None, "stock": 150, "category_id": cat_map["books"], "image_url": "https://placehold.co/400x300?text=CleanCode", "sku": "BOOK-001", "is_featured": True},
    ...
    # Home & Garden
    {"name": "Bamboo Cutting Board Set", "slug": "bamboo-cutting-board-set", "description": "Set of 3 eco-friendly bamboo cutting boards, different sizes.", "price": 39.99, "original_price": 49.99, "stock": 65, "category_id": cat_map["home-garden"], "image_url": "https://placehold.co/400x300?text=CuttingBoard", "sku": "HOME-001", "is_featured": False},
    {"name": "Indoor Plant Trio", "slug": "indoor-plant-trio", "description": "Three low-maintenance potted plants perfect for offices and homes.", "price": 59.99, "original_price": None, "stock": 25, "category_id": cat_map["home-garden"], "image_url": "https://placehold.co/400x300?text=Plants", "sku": "HOME-002", "is_featured": True},
    {"name": "Smart LED Bulb Pack", "slug": "smart-led-bulb-pack", "description": "4-pack of WiFi-controlled colour-changing LED bulbs.", "price": 44.99, "original_price": 54.99, "stock": 80, "category_id": cat_map["home-garden"], "image_url": "https://placehold.co/400x300?text=LEDBulbs", "sku": "HOME-003", "is_featured": False},
    {"name": "Garden Tool Set Pro", "slug": "garden-tool-set-pro", "description": "8-piece stainless steel garden tool set with ergonomic handles.", "price": 79.99, "original_price": 99.99, "stock": 40, "category_id": cat_map["home-garden"], "image_url": "https://placehold.co/400x300?text=GardenTools", "sku": "HOME-004", "is_featured": True},
]
